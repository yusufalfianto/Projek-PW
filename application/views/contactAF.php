...
<div>
	...
	<div class="square">
		<h3><img src="<?php echo base_url();?>/img/whatsapp.png" style="width:20px"> Whatsapp  : 0877 1128 6270</h3>
		<h3><img src="<?php echo base_url();?>/img/Line.png" style="width:20px"> Line  : @rsk098 </h3>
		<h3><img src="<?php echo base_url();?>/img/ig.png" style="width:	20px"> Instagram : @StudioRasel</h3>
	</div>
</div>
